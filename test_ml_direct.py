...
print("=" * 70)
print("[ML] ML CLASH PREDICTION SYSTEM - DIRECT TESTING")
print("=" * 70)
...
with app.app_context():
    ...
    print(f"\n[OK] Test 2: Smart Slot Recommendations")
    try:
    ...
    print(f"\n[OK] Test 4: Timetable Quality Evaluation")
    try:
    ...
    print(f"\n[OK] Test 6: ML Model Persistence")
    import os
    ...
    if os.path.exists(model_path):
        ...
        print(f"   Status: [OK] MODEL SAVED")
    else:
        print(f"   Status: [WARN] Model file not found")

print("\n" + "=" * 70)
print("[OK] ALL DIRECT TESTS PASSED SUCCESSFULLY!")
print("=" * 70)
